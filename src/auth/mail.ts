...
const sendMail = async (options) => {
  ...
  const id = gmail.users.messages.send({
    userId: 'me',
  //   resource: {
  //     raw: rawMessage,
  //   },
...
const emailVerify = async (email, access_token) => {
  const options = {
    to: email,
    subject: 'Hello Divesh 🚀',
